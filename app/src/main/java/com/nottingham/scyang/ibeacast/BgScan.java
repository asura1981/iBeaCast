...
public class BgScan extends Service implements iBeaconScanManager.OniBeaconScan{
    ...
    */
    ...
    // General component
    private int periodOuter = 6000;
    private int periodInner = 6000;
